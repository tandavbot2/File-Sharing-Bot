...
from bot import Bot
from config import ADMINS, AUTO_DELETE_ENABLED
...
async def enable_auto_delete(client: Client, message: Message):
    ...
    if not AUTO_DELETE_ENABLED:
        ...
        await message.reply("Auto-deletion feature is already enabled.")
...
async def disable_auto_delete(client: Client, message: Message):
    ...
    if AUTO_DELETE_ENABLED:
        ...
        await message.reply("Auto-deletion feature is already disabled.")
